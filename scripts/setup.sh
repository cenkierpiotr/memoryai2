...
echo ""
echo -e "  ${YELLOW}2. ENCRYPTION_KEY from .env:${NC}"
echo "     # CRITICAL: without this key, encrypted credential memories are unreadable"
echo -e "     grep ENCRYPTION_KEY ${ROOT_DIR}/.env >> /your/backup/secrets"
echo ""
echo "  Recommended frequency: nightly. Without backup, memory loss is permanent."
echo ""
echo "  Vector index (recreate after restore):"
echo "     bash ${ROOT_DIR}/scripts/create-vector-index.sh"
echo ""
